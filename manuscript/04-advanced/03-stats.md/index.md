...
```
    ...
    <matplotlib.collections.PathCollection at 0x7ff0693949d0>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7ff0692836d0>
...
```
    ...
    <matplotlib.collections.PathCollection at 0x7ff068ffe350>
...
```
    ...
    (0.7935828877005342, 0.5807486631016032)
...
```
    ...
    /home/runner/work/Network-Analysis-Made-Simple/Network-Analysis-Made-Simple/nams_env/lib/python3.7/site-packages/ipykernel_launcher.py:2: TqdmExperimentalWarning: Using `tqdm.autonotebook.tqdm` in notebook mode. Use `tqdm.tqdm` instead to force console mode (e.g. in jupyter console)
