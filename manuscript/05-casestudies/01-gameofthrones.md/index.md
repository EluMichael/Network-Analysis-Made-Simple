...
```
    ...
    <networkx.classes.graph.Graph at 0x7fd6681008d0>
...
```
    ...
    [('Eddard-Stark', 0.07239401100498258),
     ('Robert-Baratheon', 0.04851727570509947),
     ('Jon-Snow', 0.0477068906247491),
     ('Tyrion-Lannister', 0.0436743789270629),
     ('Catelyn-Stark', 0.03466703470130743),
     ('Bran-Stark', 0.02977420053980023),
     ('Robb-Stark', 0.029216183645196864),
     ('Daenerys-Targaryen', 0.027089622513021227),
     ('Sansa-Stark', 0.02696177891568318),
     ('Cersei-Lannister', 0.02163167939741897)]
